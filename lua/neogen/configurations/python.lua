                    ...
                    extract = function(node)
                        ...
                        if res.identifier and locator({ current = node }, parent.class) then
                            ...
                            if node:parent():type() == "decorated_definition" then
                                ...
                                decorator = vim.split(vim.treesitter.query.get_node_text((decorator[1],0),"\n")[1]
                ...
                ["0"] = {
                    extract = function(node)
                        ...
                        for _, assignment in pairs(nodes["assignment"]) do
                            ...
                            left_attribute = vim.split(vim.treesitter.query.get_node_text(left_attribute,0),"\n")[1]
                ...
                if type == "file" then
                    ...
                    for child in node:iter_children() do
                        if child:type() == "comment" then
                            ...
                            if start_row == 0 then
                                if vim.startswith(vim.split(vim.treesitter.query.get_node_text(node, 0),"\n")[1], "#!") then
                                    return 1, 0
                                end
                            end
                        end
